...
) ENGINE=InnoDB AUTO_INCREMENT=294 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='工单中心分类表';
...
) ENGINE=InnoDB AUTO_INCREMENT=343 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='工单sla表';
...
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='sla通知表';
...
CREATE TABLE IF NOT EXISTS `processtask_step_in_operation` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_processtask_id` (`processtask_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15890 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='工单步骤正在后台执行操作记录表';
...
CREATE TABLE IF NOT EXISTS `processtask_step_task` (
  ...
  KEY `idx_processtask_step_id` (`processtask_step_id`) USING BTREE,
  KEY `idx_processtask_id` (`processtask_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=785412139581441 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='processtask_step_task';
...
CREATE TABLE IF NOT EXISTS `processtask_step_timeaudit` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_processtask_step_id` (`processtask_step_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12731 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='工单步骤操作时间审计表';
...
-- ----------------------------
-- Table structure for processtask_approve_entity
-- ----------------------------
...
-- ----------------------------
-- Table structure for processtask_approve_entity_config
-- ----------------------------
...
-- ----------------------------
-- Table structure for processtask_final_status
-- ----------------------------
CREATE TABLE IF NOT EXISTS `processtask_final_status` (
  `processtask_id` bigint NOT NULL COMMENT '工单id',
  `status` enum('succeed','failed') COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态',
  PRIMARY KEY (`processtask_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='工单最终状态表';
