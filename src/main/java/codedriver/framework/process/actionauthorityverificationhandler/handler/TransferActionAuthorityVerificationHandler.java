...
@Service
public class TransferActionAuthorityVerificationHandler extends ProcessTaskStepUserActionAuthorityVerificationHandlerBase {

	@Override
	public String getAction() {
		return ProcessTaskStepAction.TRANSFER.getValue();
	}
