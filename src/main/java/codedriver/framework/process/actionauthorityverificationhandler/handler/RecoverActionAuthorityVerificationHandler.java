...
@Service
public class RecoverActionAuthorityVerificationHandler extends ProcessTaskStepUserActionAuthorityVerificationHandlerBase {

	@Override
	public String getAction() {
		return ProcessTaskStepAction.RECOVER.getValue();
	}
