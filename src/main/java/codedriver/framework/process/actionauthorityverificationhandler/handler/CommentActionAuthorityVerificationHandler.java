...
@Service
public class CommentActionAuthorityVerificationHandler extends ProcessTaskStepUserActionAuthorityVerificationHandlerBase {

	@Override
	public String getAction() {
		return ProcessTaskStepAction.COMMENT.getValue();
	}
