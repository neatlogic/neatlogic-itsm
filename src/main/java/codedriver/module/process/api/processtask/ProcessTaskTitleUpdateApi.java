...
public class ProcessTaskTitleUpdateApi extends ApiComponentBase {
	...
	public Object myDoService(JSONObject jsonObj) throws Exception {
		...
		IProcessTaskStepUserActionAuthorityVerificationHandler handler = ProcessTaskStepUserActionAuthorityVerificationHandlerFactory.getHandler(ProcessTaskStepAction.UPDATETITLE.getValue());
		if(handler != null) {
