...
public class ProcessTaskStepGetApi extends ApiComponentBase {
	...
	public Object myDoService(JSONObject jsonObj) throws Exception {
        ...
        checkProcessTaskParamsIsLegal(processTaskId, processTaskStepId);
        
		ProcessStepUtilHandlerFactory.getHandler().verifyActionAuthoriy(processTaskId, null, ProcessTaskStepAction.POCESSTASKVIEW);
		
		ProcessTaskVo processTaskVo = getProcessTaskDetailById(processTaskId);
	...
	private boolean checkProcessTaskParamsIsLegal(Long processTaskId, Long processTaskStepId) {
	...
	private ProcessTaskStepVo getCurrentProcessTaskStepById(Long processTaskStepId) {
        ...
        //步骤评论列表        
        processTaskStepVo.setCommentList(getProcessTaskStepCommentListByProcessTaskStepId(processTaskStepId));
        
        //获取当前用户有权限的所有子任务
        //子任务列表
        if(processTaskStepVo.getIsActive().intValue() == 1 && ProcessTaskStatus.RUNNING.getValue().equals(processTaskStepVo.getStatus())) {          
            processTaskStepVo.setProcessTaskStepSubtaskList(getProcessTaskStepSubtaskListByProcessTaskStepId(processTaskStepId));
        }
        ...
        //时效列表
        ProcessTaskVo processTaskVo = processTaskMapper.getProcessTaskBaseInfoById(processTaskId);
        processTaskStepVo.setSlaTimeList(getSlaTimeListByProcessTaskStepIdAndWorktimeUuid(processTaskStepId, processTaskVo.getWorktimeUuid()));
	...
	private List<ProcessTaskStepCommentVo> getProcessTaskStepCommentListByProcessTaskStepId(Long processTaskStepId){
	...
	private List<ProcessTaskStepSubtaskVo> getProcessTaskStepSubtaskListByProcessTaskStepId(Long processTaskStepId){
	...
	private List<ProcessTaskStepVo> getAssignableWorkerStepListByProcessTaskIdAndProcessStepUuid(Long processTaskId, String processStepUuid) {
	...
	private List<ProcessTaskSlaTimeVo> getSlaTimeListByProcessTaskStepIdAndWorktimeUuid(Long processTaskStepId, String worktimeUuid){
	...
	private void setNextStepList(ProcessTaskStepVo processTaskStepVo) {
