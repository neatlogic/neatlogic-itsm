	...
	public Object myDoService(JSONObject jsonObj) throws Exception {
	    ...
	    resultObj.put("tbodyList", new ArrayList<>());
 	    ...
 	    if(basePageVo.getNeedPage()) {
 	        int rowNum = channelMapper.getChannelTypeRelationCount(basePageVo);
 	   ...
 	   if(!basePageVo.getNeedPage() || basePageVo.getCurrentPage() <= pageCount) {
 	        List<ChannelTypeRelationVo> channelTypeRelationList = channelMapper.getChannelTypeRelationList(basePageVo);
 	        //TODO linbq引用数量
