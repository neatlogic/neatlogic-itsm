...
public class ProcessTaskFromJoinGroupAvgCostTimeSqlStructure extends ProcessSqlBase {
    ...
    public String getName() {
        return ProcessSqlTypeEnum.GROUP_AVG_TIME_COST.getValue();
    }
    ...
    public void doMyService(StringBuilder sqlSb, WorkcenterVo workcenterVo) {
        ...
        //补充统计joinTable
        StatisticsBase avgStatistics = DashboardStatisticsFactory.getStatistics(ProcessTaskDashboardStatistics.AVG_COST_TIME.getValue());
