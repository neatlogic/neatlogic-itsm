...
package codedriver.module.process.sql.core.processtaskstep.column;
...
@Component
public class ProcessTaskStepFromJoinGroupCountSqlStructure extends ProcessSqlBase {
    ...
    public void doMyService(StringBuilder sqlSb, WorkcenterVo workcenterVo) {
        getJoinTableOfGroupColumn(sqlSb, workcenterVo);
    }
}
