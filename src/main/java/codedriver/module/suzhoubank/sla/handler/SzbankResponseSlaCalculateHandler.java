...
package codedriver.module.suzhoubank.sla.handler;
...
/**
 * @author linbq
 * @since 20212/05/12 16:45
 **/
@Component
public class SzbankResponseSlaCalculateHandler extends SlaCalculateHandlerBase {
    @Override
    public String getName() {
        return "响应时效计算规则（苏州银行）";
    }

    @Override
    public SlaType getType() {
        return SlaType.RESPONSE;
    }
