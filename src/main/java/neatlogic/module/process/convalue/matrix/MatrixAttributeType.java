...
package neatlogic.module.process.convalue.matrix;
...
public enum MatrixAttributeType implements IMatrixAttributeType {
    PROCESSTASKUSER("processtaskuser", "nfpc.processtaskgroupsearch.processusertype",9, Collections.singletonList(Expression.INCLUDE), Expression.INCLUDE);
