...
@Service
public class AutoApprovalRegulateHandler implements IRegulateHandler {
    /**
     * 自动审批
     **/
    @Override
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Integer autoApproval = oldConfigObj.getInteger("autoApproval");
        autoApproval = autoApproval == null ? 0 : autoApproval;
        newConfigObj.put("autoApproval", autoApproval);
    }
}
