...
@Service
public class IsNeedContentRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Integer isNeedContent = oldConfigObj.getInteger("isNeedContent");
        isNeedContent = isNeedContent == null ? 1 : isNeedContent;
        newConfigObj.put("isNeedContent", isNeedContent);
    }
}
