...
@Service
public class ReplaceableTextListRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        newConfigObj.put("replaceableTextList", ProcessConfigUtil.regulateReplaceableTextList(oldConfigObj.getJSONArray("replaceableTextList")));
    }
}
