...
@Service
public class TaskConfigRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        JSONObject taskConfig = oldConfigObj.getJSONObject("taskConfig");
        newConfigObj.put("taskConfig", taskConfig);
    }
}
