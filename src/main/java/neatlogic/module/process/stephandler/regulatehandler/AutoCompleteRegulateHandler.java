...
@Service
public class AutoCompleteRegulateHandler implements IRegulateHandler {
    /* 自动流转 **/
    @Override
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        ...
        Integer autoComplete = oldConfigObj.getInteger("autoComplete");
        autoComplete = autoComplete == null ? 0 : autoComplete;
        newConfigObj.put("autoComplete", autoComplete);
    }
}
