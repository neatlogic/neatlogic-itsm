...
@Service
public class CommentTemplateIdRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Long commentTemplateId = oldConfigObj.getLong("commentTemplateId");
        if (commentTemplateId != null) {
            newConfigObj.put("commentTemplateId", commentTemplateId);
        }
    }
}
