...
@Service
public class IsNeedUploadFileRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Integer isNeedUploadFile = oldConfigObj.getInteger("isNeedUploadFile");
        isNeedUploadFile = isNeedUploadFile == null ? 1 : isNeedUploadFile;
        newConfigObj.put("isNeedUploadFile", isNeedUploadFile);
    }
}
