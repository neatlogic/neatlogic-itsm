...
@Service
public class IsRequiredRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Integer isRequired = oldConfigObj.getInteger("isRequired");
        isRequired = isRequired == null ? 0 : isRequired;
        newConfigObj.put("isRequired", isRequired);
    }
}
