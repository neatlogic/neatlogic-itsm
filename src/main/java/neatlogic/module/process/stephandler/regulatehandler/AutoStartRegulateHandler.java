...
@Service
public class AutoStartRegulateHandler implements IRegulateHandler {
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        Integer autoStart = oldConfigObj.getInteger("autoStart");
        autoStart = autoStart == null ? 1 : autoStart;
        newConfigObj.put("autoStart", autoStart);
    }
}
