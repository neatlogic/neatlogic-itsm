...
@Service
public class FormSceneNameRegulateHandler implements IRegulateHandler {

    @Override
    public String getName() {
        return "formSceneName";
    }
    ...
    public void regulateConfig(IProcessStepInternalHandler processStepInternalHandler, JSONObject oldConfigObj, JSONObject newConfigObj) {
        String formSceneName = oldConfigObj.getString("formSceneName");
        newConfigObj.put("formSceneName", formSceneName == null ? "" : formSceneName);
    }
}
