...
/**
 * 门户“我的已办”小组件数据处理器，复用工单中心预置“我的已办”视图的数据权限和条件。
 */
@Component
public class DoneOfMineProcessTaskPortalWidgetDataHandler extends PortalWidgetDataHandlerBase {

    private static final String WORKCENTER_UUID = "doneOfMineProcessTask";
    ...
    public String getHandler() {
        return "process.doneOfMineProcessTask";
    }
