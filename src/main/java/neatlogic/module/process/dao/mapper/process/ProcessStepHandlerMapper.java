...
public interface ProcessStepHandlerMapper extends IProcessStepHandlerCrossoverMapper {

    List<ProcessStepHandlerVo> getProcessStepHandlerConfig();

	String getProcessStepHandlerConfigByHandler(String handler);

    int replaceProcessStepHandlerConfig(ProcessStepHandlerVo stepHandlerVo);
}
