...
@Component
public class ProcessTaskFromJoinGroupHandlePunctualitySqlStructure extends DashboardProcessSqlBase {
    ...
    public void doService(StringBuilder sqlSb, DashboardWidgetParamVo dashboardWidgetParamVo) {
        buildStatisticsFromJoinSql(sqlSb, dashboardWidgetParamVo, ProcessTaskDashboardStatistics.HANDLE_PUNCTUALITY);
    }
}
