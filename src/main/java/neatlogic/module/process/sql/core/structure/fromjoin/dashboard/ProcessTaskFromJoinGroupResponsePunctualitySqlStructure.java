...
@Component
public class ProcessTaskFromJoinGroupResponsePunctualitySqlStructure extends DashboardProcessSqlBase {
    ...
    public void doService(StringBuilder sqlSb, DashboardWidgetParamVo dashboardWidgetParamVo) {
        buildStatisticsFromJoinSql(sqlSb, dashboardWidgetParamVo, ProcessTaskDashboardStatistics.RESPONSE_PUNCTUALITY);
    }
}
