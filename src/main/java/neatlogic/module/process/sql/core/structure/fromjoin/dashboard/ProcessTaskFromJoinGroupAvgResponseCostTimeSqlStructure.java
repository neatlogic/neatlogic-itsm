...
@Component
public class ProcessTaskFromJoinGroupAvgResponseCostTimeSqlStructure extends DashboardProcessSqlBase {
    ...
    public void doService(StringBuilder sqlSb, DashboardWidgetParamVo dashboardWidgetParamVo) {
        buildStatisticsFromJoinSql(sqlSb, dashboardWidgetParamVo, ProcessTaskDashboardStatistics.AVG_RESPONSE_COST_TIME);
    }
}
