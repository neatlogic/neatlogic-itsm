...
@Component
public class ProcessTaskColumnGroupHandlePunctualitySqlStructure extends DashboardProcessSqlBase {
    ...
    public void doService(StringBuilder sqlSb, DashboardWidgetParamVo dashboardWidgetParamVo) {
        buildStatisticsColumnSql(sqlSb, dashboardWidgetParamVo, ProcessTaskDashboardStatistics.HANDLE_PUNCTUALITY);
    }
}
