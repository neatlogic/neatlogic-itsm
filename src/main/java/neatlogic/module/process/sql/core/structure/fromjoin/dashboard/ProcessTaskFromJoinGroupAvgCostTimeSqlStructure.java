...
@Component
public class ProcessTaskFromJoinGroupAvgCostTimeSqlStructure extends DashboardProcessSqlBase {
    ...
    public void doService(StringBuilder sqlSb, DashboardWidgetParamVo dashboardWidgetParamVo) {
        buildStatisticsFromJoinSql(sqlSb, dashboardWidgetParamVo, ProcessTaskDashboardStatistics.AVG_HANDLE_COST_TIME);
    }
}
