...
public class SqlGroupByDecorator extends SqlDecoratorBase {
    ...
    public <T extends SqlDecoratorVo> void myBuild(StringBuilder sqlSb, T sqlDecoratorVo) {
        IProcessSqlStructure processSqlStructure = ProcessSqlStructureFactory.getProcessSqlStructure(ProcessTaskDashboardHandler.class.getName(),"groupBy", sqlDecoratorVo.getSqlFieldType());
