...
public class ProcessTaskStatusMatrixPrivateDataSourceHandler implements IMatrixPrivateDataSourceHandler {
    ...
    public String getName() {
        return $.t("nmpmh.processtaskstatusmatrixprivatedatasourcehandler.getname");
    }
    ...
    private Boolean checkFilter(ProcessTaskStatus status , List<MatrixFilterVo> filterList){
