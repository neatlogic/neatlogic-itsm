...
config. BalloonImgPath = '/balantflow/resources/module/balantknows/js/tooltip/tip_balloon/'; // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
