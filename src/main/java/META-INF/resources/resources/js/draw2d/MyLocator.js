...
draw2d.layout.locator.MyLeftLocator = draw2d.layout.locator.Locator.extend({
    ...
    relocate:function(index, target)
    {
        ...
        target.setPosition(-targetBoundingBox.w + 10, (boundingBox.h / 2 ) - (targetBoundingBox.h / 2 ) + 5);
    }
});
...
draw2d.layout.locator.MyRightLocator = draw2d.layout.locator.Locator.extend({
    ...
    relocate:function(index, target)
    {
        ...
        var targetBoundingBox = target.getBoundingBox();
        target.setPosition(boundingBox.w ,(boundingBox.h/2)-(targetBoundingBox.h/2) + 5);
    }
});