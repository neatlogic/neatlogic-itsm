		...
		if (!window.ActiveXObject && !!document.createElement("canvas").getContext) {
			CAV = {
				...
				CAV.Material = function(a, b) {
					this.ambient = new CAV.Color(a || "#666666");
					this.diffuse = new CAV.Color(b || "#FFFFFF");
				...
				CAV.CanvasRenderer.prototype.render = function(a) {
					...
					return this
	                    ...
	                    var z = document.getElementById("divLogo");
	                    var w = $("#divLogo");
	                    var D, I, h, q, y;
	                    var g;
	                    var r;
	                    ...
	                    function s() {
	                        ...
	                        for (N = q.vertices.length - 1; N >= 0; N--) {
	                            ...
	                            O.step = CAV.Vector3.create(Math.randomInRange(0.8, 1), Math.randomInRange(0.8, 1), Math.randomInRange(0.8, 1));
