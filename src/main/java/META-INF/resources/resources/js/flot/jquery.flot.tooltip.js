        ...
        if( $('#flotTip').length > 0 ){
            ...
            if(this.tooltipOptions.defaultTheme) {
                $tip.css({
                    'background': '#fff',
                    'z-index': '100',
                    'padding': 'http://www.lab.westilian.com/alpona/js/0.4em 0.6em',
                    'border-radius': 'http://www.lab.westilian.com/alpona/js/0.5em',
                    'font-size': 'http://www.lab.westilian.com/alpona/js/0.8em',
