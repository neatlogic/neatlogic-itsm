...
(function($) {
	...
	$.fn.raty = function(settings) {
		...
		// TODO: Using var for values that will be used into a function later (on/bind), to keep the current value and not the last one. Why, Mr. Anderson? Why? 
