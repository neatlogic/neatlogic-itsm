...
cubism.context = function() {
  var context = new cubism_context,
      ...
      scale = context.scale = d3.time.scale().range([0, size/4]),
      timeout,
      focus;
...
cubism_contextPrototype.axis = function() {
  ...
  function axis(selection) {
    ...
    var g = selection.append("svg")
        .datum({id: id})
        .attr("width", context.size()+8)
        .attr("height", Math.max(20, -axis.tickSize()))
      .append("g")
        .attr("transform", "translate(0," + (axis_.orient() === "top" ? 20 : 4) + ")")
        .call(axis_);
