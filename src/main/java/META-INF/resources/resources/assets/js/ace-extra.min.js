...
ace.settings = {
	...
	setV : function(b, a, c) {
		ace.data.set("settings", b + "-" + a, c)
	},
	get : function(b, a) {
		return ace.data.get("settings", b + "-" + a)
	},
	unset : function(b, a) {
		ace.data.set("settings", b + "-" + a, -1)
	},
...
ace.settings.skin = function() {
	var a = jQuery;
	var d = ace.settings.get("skin", "selected");
	var g = ace.settings.get("colorpicker", "selected");
	...
	a('.colorpick-btn').each(function(){
		if(a(this).data('color') == g){
			a(this).addClass('selected');
		}
	});
	a('.btn-colorpicker').css('background-color', g);
};
