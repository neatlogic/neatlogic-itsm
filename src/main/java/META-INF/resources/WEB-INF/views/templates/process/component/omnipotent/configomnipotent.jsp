	...
	<div role="tabpanel">
		<ul class="nav-bdbottom nav-tabs" role="tablist" id="ul-tablist">
			<li role="presentation" class="active">
				<a href="#base" role="tab" data-toggle="tab">基本设置</a>
			</li>
			<li role="presentation">
				<a href="#attribute" role="tab" data-toggle="tab">属性设置</a>
			</li>
			<li role="presentation" id="lnkFormConfig" style="display: none">
				<a href="#form" role="tab" data-toggle="tab">表单设置</a>
			</li>
			<li role="presentation" id="lnkAssignConfig">
				<a href="#worker" role="tab" data-toggle="tab">指派设置</a>
			</li>
			<li role="presentation" id="lnkExpireConfig">
				<a href="#expire" role="tab" data-toggle="tab">超时设置</a>
			</li>
		</ul>
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="worker">
				<div class="form-block form-block-12">
					<span class="block-left"> 自动开始：</span>
					<div class="block-right">
						...
						<div class="help-block">帮助：如果分派结果只有一个处理人，自动开始当前步骤</div>
					</div>
				</div>
				<div class="form-block form-block-12">
					<span class="block-left"> 执行方式：</span>
					<div class="block-right">
						<select plugin-checkselect id="sltAssignPolicy" name="assignPolicy" data-searchable="false">
							<option value="parallel" {{?it.userData && it.userData.assignPolicy=='parallel'}}selected{{?}}>全部执行</option>
							<option value="serial" {{?it.userData && it.userData.assignPolicy=='serial'}}selected{{?}}>顺序执行</option>
						</select>
						<div class="help-block">全部执行：指派策略会全部执行，顺序执行：指派策略按顺序执行，找不到任何处理人则会执行下一个策略，找到处理人则不再执行余下策略。</div>
					</div>
				</div>
				<div class="form-block form-block-12">
					<span class="block-left">
						<i style="color: red">*</i>指派策略：</span>
					<div class="block-right">
						<div class="btn-group open">
							...
							<ul class="dropdown-menu">
								<%-- <li>
									<a class="lnkWorkerPolicy" data-policy="assign" href="javascript:void(0)">管理员指定</a>
								</li>--%>
								<li>
									<a class="lnkWorkerPolicy" data-policy="manual" href="javascript:void(0)">处理人抢单</a>
								</li>
								<li>
									<a class="lnkWorkerPolicy" data-policy="automatic" href="javascript:void(0)">分配器分派</a>
								</li>
								<li>
									<a class="lnkWorkerPolicy" data-policy="attribute" href="javascript:void(0)">属性值</a>
								</li>
								<li>
									<a class="lnkWorkerPolicy" data-policy="form" href="javascript:void(0)">表单值</a>
								</li>
								<li>
									<a class="lnkWorkerPolicy" data-policy="copy" href="javascript:void(0)">复制前置步骤</a>
								</li>
							</ul>
						</div>
			...
			<div role="tabpanel" class="tab-pane" id="expire">
				<div class="form-block form-block-12">
					<span class="block-left">超时策略：</span>
					<div class="block-right">
						<div class="btn-group open">
							<button type="button" class="btn btn-lesser dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
								添加超时策略
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li>
									<a class="lnkTimeoutPolicy" data-policy="simple" href="javascript:void(0)">简易策略</a>
								</li>
								<li>
									<a class="lnkTimeoutPolicy" data-policy="advanced" href="javascript:void(0)">高级策略</a>
								</li>
							</ul>
						</div>
