...
<form id="form_workerpolicy_{{=it.policy}}">
	<div class="help-block">${tk:lang("请选择处理人范围","") }</div>
	<div>
		<select plugin-inputselect class="sltManualUser" data-url="${pageContext.request.contextPath}/user/searchuserandteam" multiple>
